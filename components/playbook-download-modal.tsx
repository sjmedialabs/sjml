  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="relative bg-background rounded-2xl p-8 max-w-md w-full mx-4 border border-[#E63946]/30">
        ...
        {/* Title */}
        <h2 className="text-2xl font-bold text-foreground mb-2">Download Playbook</h2>
          ...
          <form onSubmit={handleSendOtp} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-secondary border border-border rounded-lg text-foreground focus:border-[#E63946] focus:outline-none"
          ...
          <form onSubmit={handleVerifyOtp} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                maxLength={6}
                className="w-full px-4 py-3 bg-secondary border border-border rounded-lg text-foreground focus:border-[#E63946] focus:outline-none text-center text-2xl tracking-widest"
                placeholder="000000"
              />

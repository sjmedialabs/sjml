      ...
      <div className="grid grid-cols-3 gap-6">
          ...
          <div className="space-y-2">
            {data.caseStudies.map((study) => (
              ...
              >
                ...
                <div className="text-xs opacity-70">{study.client || "No client"}</div>
              </button>
            ))}
            {data.caseStudies.length === 0 && (
              <p className="text-[#666] text-sm text-center py-4">No case studies yet</p>
            )}
          </div>
        </div>
        ...
        <div className="col-span-2 bg-[#111] border border-[#222] rounded-xl p-6">
          {editingStudy ? (
            <div>
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-lg font-semibold text-white">Edit Case Study</h2>
                <button
            ...
            <div className="text-center text-[#666] py-12">Select a case study to edit or add a new one</div>
          )}
        </div>
      </div>

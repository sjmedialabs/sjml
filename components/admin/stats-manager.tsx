  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold admin-text-primary mb-2">Statistics</h1>
          <p className="admin-text-secondary">Manage the statistics displayed on your homepage.</p>
        </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {stats.map((stat) => (
          <Card key={stat.id} className="admin-card admin-border">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label className="admin-text-primary">Value</Label>
                <Input
                  value={stat.value}
              ...
              <div className="space-y-2">
                <Label className="admin-text-primary">Label</Label>
                <Input
                  value={stat.label}

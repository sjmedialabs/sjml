        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <div className="flex flex-col text-left">
              <span className="text-white font-bold leading-tight">SJ MEDIA LABS</span>
              <span className="text-[#666] text-xs tracking-wider">ADMIN PANEL</span>
            </div>
          </div>
          <h1 className="text-2xl font-bold text-white mb-2">Welcome Back</h1>
          <p className="text-[#888]">Sign in to access the dashboard</p>
        </div>
        ...
        <div className="bg-[#111] border border-[#222] rounded-xl p-8">
          ...
          <div className="mt-6 p-4 bg-[#1a1a1a] rounded-lg">
            <p className="text-[#888] text-sm text-center">
              <strong className="text-[#E63946]">Default Credentials:</strong>
              <br />

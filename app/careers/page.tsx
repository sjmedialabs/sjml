    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="py-16 px-4 bg-background">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-muted-foreground text-center mb-12">Find your next opportunity with us</p>
          ...
          {publishedJobs.length > 0 ? (
            <div className="space-y-4">
              {publishedJobs.map((job: any) => (
                <div
                  key={job.id}
                  className="bg-background border border-border rounded-xl p-6 hover:border-[#E63946]/50 transition-colors group"
                >
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-foreground mb-2 group-hover:text-[#E63946] transition-colors">
                        {job.title}
                      </h3>
            ...
            <div className="text-center py-12 bg-background border border-border rounded-xl">
              ...
              <p className="text-muted-foreground text-sm mt-2">Check back later or send us your resume.</p>
            </div>
          )}
        </div>
      </section>
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <a
              ...
              className="inline-block px-8 py-4 bg-background border border-border text-foreground rounded-full font-medium hover:border-[#E63946] transition-colors"
            >
